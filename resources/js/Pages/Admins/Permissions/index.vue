                            ...
                            <div class="overflow-x-auto">
                                <table class="table table-compact w-full">
                                    ...
                                    <tr v-for="(permission, index) in permissions.data" :key="index">
                                        <th class="border px-4 py-2 w-10">{{ permission.id }}</th>
                                        <td class="border px-4 py-2">{{ permission.name }}</td>
                                        <td class="border px-4 py-2">{{ permission.guard_name }}</td>
                                        <td class="border px-4 py-2 text-center">
                                            <Link :href="route('admin.permissions.edit', permission.id)" class="btn btn-outline btn-square btn-warning h-6 w-6 btn-xs tooltip" data-tip="sunting">
                                                <center>
                                            ...
                                            <Link @click="destroy(permission.id)" class="btn btn-outline btn-square btn-error h-6 w-6 btn-xs tooltip" data-tip="hapus">
                                                <center>
                                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
