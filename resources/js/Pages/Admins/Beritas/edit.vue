                                ...
                                <ol class="inline-flex items-center space-x-1 md:space-x-3">
                                    ...
                                    <li>
                                        <div class="flex items-center">
                                            ...
                                            <div class="text-gray-700 ml-1 md:ml-2 text-sm font-medium">
                                                <Link 
                                                    :href="route('admin.beritas.edit', form.id)"
                                                >
                                                    Sunting
                                                </Link>
                                            </div>
                                ...
                                <div class="grid grid-cols-6 gap-6">
                                    ...
                                    <div class="col-span-6 sm:col-span-3">
                                        ...
                                        <select class="mt-1 form-select form-select-lg focus:ring-indigo-500 focus:border-indigo-500 cursor-pointer block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"
                                            v-model="form.status">
                                                <option value=0 key:form.status>Posting</option>
                                                <option value=1 key:form.status>Pending</option>
                                        </select>
...
export default {
    ...
    methods: {
        updateData(){
            this.form.post(this.route('admin.beritas.update', this.editData.id), {
                errorBag: 'updateData'
            });
        },
